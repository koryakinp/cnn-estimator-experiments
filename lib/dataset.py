...
class DataSet:
    def __init__(self, in_dir, exts='.jpg'):
        ...
        for name in os.listdir(in_dir):
            ...
            if os.path.isdir(current_dir):
                ...
                # Append them to the list of all filenames for the
                # training-set.
                ...
                # Append them to the list of all class-numbers for the
                # training-set.
                ...
                # Append them to the list of all class-numbers
                # for the test-set.
    ...
    def _get_filenames(self, dir):
        """
        Create and return a list of filenames with matching extensions
    ...
    def get_paths(self, test=False):
        ...
        :param test:
            Boolean. Return the paths for the test-set (True)
            or training-set (False).
    ...
    def get_training_set(self):
        ...
        return list(
          self.get_paths()), np.asarray(
            self.class_numbers), one_hot_encoded(
    ...
    def get_test_set(self):
        ...
        return list(self.get_paths(test=True)), np.asarray(
          self.class_numbers_test), one_hot_encoded(
            class_numbers=self.class_numbers_test,
    ...
    def copy_files(self, train_dir, test_dir):
        ...
        :param train_dir: Directory for the training-set e.g.
        'knifey-spoony/train/'
